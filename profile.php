...
<br>
  <input type="submit" name="imagebtn" value="UPDATE DP" class="submitbtn btn-primary"></input> 
  </div> 
  </form>
  </div>
                    ...
                    if (in_array($fileactualext10,$allowed10)) {
                        ...
                        if ($fileerror10==0) {
                            if ($filesize10<50000000000) {
                                ...
                                echo"<span class='badge rounded-pill bg-success'>DP Updated Successfully</span>";
