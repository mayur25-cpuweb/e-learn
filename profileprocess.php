...
if ($nameErr =="" && $emailErr =="" && $genderErr =="" && $contactErr =="" && $cityerr =="" && $stateerr =="" && $passerr =="" && $passconfirmerr =="")
 {
    ...
    //     $register = "INSERT INTO registration(rname,email,mnumber, address, city, state, gender,password,image)
    ...
    //         $doneerror= "<span class='badge rounded-pill bg-danger'>ERROR: Could not able to execute $sql</span>" . mysqli_error($conn);
    //     }
    //                                    }else{
