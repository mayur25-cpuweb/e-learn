...
if (in_array($fileactualext1,$allowed1)) {
    ...
    if ($fileerror1==0) {
        if ($filesize1<50000000000) {
            ...
            $query1 = "UPDATE coursevideos SET videourl1 = '".$filedir1."',vname1='".$vname1."',vtext1='".$vtext1."'
...
if (isset($_POST['submitimage2'])){
  ...
  $vname2=$_POST['vname2'];
  $vtext2=$_POST['vtext2'];
  if (empty($vname2 && $vtext2)) {
    echo"<span class='badge rounded-pill bg-danger'>Enter video-2 Details</span><br>";
  } else{
...
if (in_array($fileactualext2,$allowed2)) {
    if ($fileerror2==0) {
        if ($filesize2<5000000000) {
            ...
            $query2 ="UPDATE coursevideos SET videourl2 = '".$filedir2."',vname2='".$vname2."',vtext2='".$vtext2."'WHERE addedvideocourseid='".$id."'";
...
if (isset($_POST['submitimage3'])){
  ...
  $vname3=$_POST['vname3'];
  $vtext3=$_POST['vtext3'];
  if (empty($vname3 && $vtext3)) {
    echo"<span class='badge rounded-pill bg-danger'>Enter video-3 Details</span><br>";
  } else{
...
if (in_array($fileactualext3,$allowed3)) {
    if ($fileerror3==0) {
        if ($filesize3<5000000000) {
            ...
            $query3 ="UPDATE coursevideos SET videourl3 = '".$filedir3."',vname3='".$vname3."',vtext3='".$vtext3."'WHERE addedvideocourseid='".$id."'";
...
if (isset($_POST['submitimage4'])){
  ...
  $vname4=$_POST['vname4'];
  $vtext4=$_POST['vtext4'];
  if (empty($vname4 && $vtext4)) {
    echo"<span class='badge rounded-pill bg-danger'>Enter video-4 Details</span><br>";
  } else{
...
if (in_array($fileactualext4,$allowed4)) {
    if ($fileerror4==0) {
        if ($filesize4<8388608000) {
            ...
            $query4 = "UPDATE coursevideos SET videourl4 = '".$filedir4."',vname4='".$vname4."',vtext4='".$vtext4."'WHERE addedvideocourseid='".$id."'";
